    ...
    <div id="admin-workspace" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-gray-300 font-sans">
      ...
      <div className="space-y-4 mb-8 text-center md:text-left">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/35 text-[#D4AF37] text-xs tracking-wider font-mono uppercase">
          <Shield size={12} />
          <span>{t('admin_restricted_console')}</span>
        </div>
      ...
      <div className="flex flex-wrap gap-2 mb-8 select-none border-b border-[#D4AF37]/20 pb-3 text-xs sm:text-sm font-semibold">
        {(['analytics', 'monuments', 'tours', 'products', 'bookings', 'orders'] as const).map(tab => (
          ...
          >
            {tab === 'analytics' ? t('admin_kpi') : t(`admin_${tab}`)}
          </button>
        ))}
      </div>
      ...
      {adminTab === 'analytics' && (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 font-sans">
            ...
            <div className="bg-[#121212] border border-[#D4AF37]/20 p-6 rounded-2xl shadow-sm flex items-center justify-between">
              <div className="space-y-2">
                <span className="text-[10px] text-[#D4AF37] font-bold uppercase tracking-wider block">{t('admin_kpi_users')}</span>
            ...
            <div className="bg-[#121212] border border-[#D4AF37]/20 p-6 rounded-2xl shadow-sm flex items-center justify-between">
              <div className="space-y-2">
                <span className="text-[10px] text-[#D4AF37] font-bold uppercase tracking-wider block">{t('admin_kpi_bookings')}</span>
            ...
            <div className="bg-[#121212] border border-[#D4AF37]/20 p-6 rounded-2xl shadow-sm flex items-center justify-between">
              <div className="space-y-2">
                <span className="text-[10px] text-[#D4AF37] font-bold uppercase tracking-wider block">{t('admin_kpi_orders')}</span>
            ...
            <div className="bg-[#121212] border border-[#D4AF37]/20 p-6 rounded-2xl shadow-sm flex items-center justify-between">
              <div className="space-y-2">
                <span className="text-[10px] text-[#D4AF37] font-bold uppercase tracking-wider block">{t('admin_kpi_revenue')}</span>
          ...
          <div className="bg-[#121212] border border-[#D4AF37]/20 rounded-2xl p-6 shadow-sm">
            <h3 className="font-serif text-lg font-bold text-white mb-4 pb-2 border-b border-[#D4AF37]/10">{t('admin_users_table')} ({users.length})</h3>
            <div className="overflow-x-auto text-xs">
              <table className="w-full text-left border-collapse font-sans">
                <thead>
                  <tr className="border-b border-[#D4AF37]/15 text-gray-400 font-mono text-[10px] uppercase">
                    <th className="py-3 px-4">{t('admin_users_name')}</th>
                    <th className="py-3 px-4">{t('admin_users_role')}</th>
                    <th className="py-3 px-4">{t('admin_users_phone')}</th>
                    <th className="py-3 px-4">{t('admin_users_address')}</th>
                    <th className="py-3 px-4">{t('admin_users_date')}</th>
                  </tr>
                </thead>
                <tbody>
                  {users.map(u => (
      ...
      {adminTab === 'monuments' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-xs sm:text-sm font-sans">
          ...
          <div className="lg:col-span-5 bg-[#121212] border border-[#D4AF37]/25 p-6 rounded-2xl">
            <h3 className="font-serif text-lg font-bold text-white mb-4">{editingId ? t('admin_mon_edit') : t('admin_mon_add')}</h3>
            
            <form onSubmit={handleMonSubmit} className="space-y-4">
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_mon_name')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_mon_gov')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_mon_image')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_mon_desc')}</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_mon_foreign_price')}</label>
                ...
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_mon_local_price')}</label>
              ...
              <div className="pt-2 flex gap-2">
                <button type="submit" className="px-5 py-2.5 bg-[#D4AF37] hover:bg-[#F3E5AB] text-black rounded-xl font-bold uppercase tracking-wider text-xs flex-1 cursor-pointer transition-colors duration-150">
                  {editingId ? t('admin_mon_submit_edit') : t('admin_mon_submit_add')}
                </button>
                {editingId && (
          ...
          <div className="lg:col-span-7 space-y-4">
            <h3 className="font-serif text-lg font-bold text-white pb-2 border-b border-[#D4AF37]/15">{t('admin_mon_archive')} ({monuments.length})</h3>
      ...
      {adminTab === 'tours' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-xs sm:text-sm font-sans">
          ...
          {/* Write panel (5 columns) */}
          <div className="lg:col-span-5 bg-[#121212] border border-[#D4AF37]/25 p-6 rounded-2xl">
            <h3 className="font-serif text-lg font-bold text-white mb-4">{editingId ? t('admin_tour_edit') : t('admin_tour_add')}</h3>
            
            <form onSubmit={handleTourSubmit} className="space-y-4">
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_tour_title')}</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_tour_price')}</label>
                ...
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_tour_slots')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_tour_city')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_tour_image')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_tour_desc')}</label>
              ...
              <div className="pt-2 flex gap-2">
                <button type="submit" className="px-5 py-2.5 bg-[#D4AF37] hover:bg-[#F3E5AB] text-black rounded-xl font-bold uppercase tracking-wider text-xs flex-1 cursor-pointer transition-colors duration-150">
                  {editingId ? t('admin_tour_submit_edit') : t('admin_tour_submit_add')}
                </button>
                {editingId && (
          ...
          {/* List panel (7 columns) */}
          <div className="lg:col-span-7 space-y-4">
            <h3 className="font-serif text-lg font-bold text-white pb-2 border-b border-[#D4AF37]/15">{t('admin_tour_db_catalogs')} ({tours.length})</h3>
            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2">
              {tours.map(t => (
                <div key={t.id} className="p-4 border border-[#D4AF37]/15 rounded-xl bg-[#121212] flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0 font-sans">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#D4AF37] font-mono font-medium">${t.price} USD • {t.slots_available} {t('slots_left')}</p>
                    </div>
                  </div>
                  <div className="flex gap-2">
      ...
      {adminTab === 'products' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-xs sm:text-sm font-sans">
          ...
          {/* Write panel (5 columns) */}
          <div className="lg:col-span-5 bg-[#121212] border border-[#D4AF37]/25 p-6 rounded-2xl">
            <h3 className="font-serif text-lg font-bold text-white mb-4">{editingId ? t('admin_prod_edit') : t('admin_prod_add')}</h3>
            
            <form onSubmit={handleProdSubmit} className="space-y-4">
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_prod_name')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_prod_cat')}</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_prod_price')}</label>
                ...
                <div className="space-y-1">
                  <label className="font-semibold text-gray-300 block">{t('admin_prod_stock')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_prod_image')}</label>
              ...
              <div className="space-y-1">
                <label className="font-semibold text-gray-300 block">{t('admin_prod_desc')}</label>
              ...
              <div className="pt-2 flex gap-2">
                <button type="submit" className="px-5 py-2.5 bg-[#D4AF37] hover:bg-[#F3E5AB] text-black rounded-xl font-bold uppercase tracking-wider text-xs flex-1 cursor-pointer transition-colors duration-150">
                  {editingId ? t('admin_prod_submit_edit') : t('admin_prod_submit_add')}
                </button>
                {editingId && (
          ...
          {/* List panel (7 columns) */}
          <div className="lg:col-span-7 space-y-4">
            <h3 className="font-serif text-lg font-bold text-white pb-2 border-b border-[#D4AF37]/15">{t('admin_prod_list')} ({products.length})</h3>
            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2">
              {products.map(p => (
                <div key={p.id} className="p-4 border border-[#D4AF37]/15 rounded-xl bg-[#121212] flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0 font-sans">
                      ...
                      <p className="text-xs text-[#D4AF37] font-mono font-medium">${p.price} USD • {t('items_left')}: {p.stock} units</p>
                    </div>
                  </div>
                  <div className="flex gap-2">
      ...
      {adminTab === 'bookings' && (
        <div className="bg-[#121212] border border-[#D4AF37]/20 rounded-2xl p-6 shadow-sm font-sans text-xs sm:text-sm">
          <h3 className="font-serif text-lg font-bold text-white mb-4 pb-2 border-b border-[#D4AF37]/10">{t('admin_booking_review')} ({bookings.length})</h3>
          
          {bookings.length === 0 ? (
            <div className="py-12 text-center text-gray-400">{t('admin_booking_no_bookings')}</div>
          ) : (
                ...
                <div key={b.id} className="border border-[#D4AF37]/15 bg-black/30 p-5 rounded-2xl hover:border-[#D4AF37]/35 transition-all flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div className="space-y-1.5 min-w-0 max-w-xl">
                    <div className="flex items-center gap-2 font-mono text-[9px] text-[#D4AF37]">
                      <span>{t('admin_booking_id')} {b.id}</span>
                      <span>•</span>
                      <span>{t('admin_booking_enlisted')} {new Date(b.created_at).toLocaleDateString()}</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-1 text-xs text-gray-400 font-sans mt-2">
                      <div>{t('admin_booking_date')} <strong className="text-white">{b.tour_date}</strong></div>
                      <div>{t('admin_booking_party')} <strong className="text-white">{b.number_of_people} {t('people')}</strong></div>
                      <div>{t('admin_booking_tourist')} <strong className="text-[#D4AF37] truncate block">{b.user?.full_name || 'Guest Tourist'}</strong></div>
                      <div>{t('admin_booking_contact')} <strong className="text-gray-300 font-mono block">{b.contact_info?.alt_phone || 'None'}</strong></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-start md:items-end gap-2 shrink-0">
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 font-mono text-[9px] uppercase font-bold">{t('admin_booking_status')}</span>
                    ...
                    {b.status === 'pending' && (
                      <div className="flex gap-2">
                        ...
                        >
                          <Check size={11} /> {t('admin_booking_confirm')}
                        </button>
                        <button
                        ...
                        >
                          <X size={11} /> {t('admin_booking_reject')}
                        </button>
                      </div>
                    )}
                  </div>
      ...
      {adminTab === 'orders' && (
        <div className="bg-[#121212] border border-[#D4AF37]/20 rounded-2xl p-6 shadow-sm font-sans text-xs sm:text-sm">
          <h3 className="font-serif text-lg font-bold text-white mb-4 pb-2 border-b border-[#D4AF37]/10">{t('admin_order_oversight')} ({orders.length})</h3>
          
          {orders.length === 0 ? (
            <div className="py-12 text-center text-gray-400 font-sans text-xs">{t('admin_order_no_orders')}</div>
          ) : (
            <div className="space-y-4">
              {orders.map((o) => (
                <div key={o.id} className="border border-[#D4AF37]/15 bg-black/30 p-5 rounded-2xl hover:border-[#D4AF37]/35 transition-all font-sans text-xs">
                  ...
                  <div className="flex flex-col md:flex-row justify-between pb-3 border-b border-[#D4AF37]/10 mb-3 gap-2">
                    <div>
                      <div className="font-mono text-[10px] text-[#D4AF37]">{t('admin_order_id')} <span className="font-bold text-white">{o.id}</span></div>
                      <span className="text-[10px] text-gray-400 font-mono">{t('admin_order_registered')} {new Date(o.created_at).toLocaleDateString()}</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div>
                        {t('admin_booking_status')} <span className={`px-2 py-0.5 rounded text-[10px] uppercase font-bold font-mono ${
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 pt-2">
                    <span className="text-gray-400 font-mono text-[9px] block">
                      {t('admin_order_customer')} <strong className="text-white">{o.customer_name}</strong> ({o.phone}) | {t('admin_order_shipping_to')} <strong className="text-[#D4AF37]">{o.shipping_address}</strong>
                    </span>
